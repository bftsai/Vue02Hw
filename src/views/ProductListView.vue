      ...
      <div class="row py-3">
          ...
          <table class="table table-hover mt-4">
            ...
            <tbody>
              <tr v-for="(item) in products" :key="item.id">
                ...
                <td width="120">
                  <button @click="tempProduct = item" type="button" class="btn btn-primary">查看細節</button>
                </td>
              </tr>
            </tbody>
          </table>
        ...
        <div class="col-md-6">
          ...
          <template v-if="tempProduct.title">
            ...
            <template>
              <span v-for="(img, id) in tempProduct.imagesUrl" :key = "id">
                <img :src="img" alt="`${tempProduct.category}照片`" class="images m-2">
              </span>
            </template>
          </template>
